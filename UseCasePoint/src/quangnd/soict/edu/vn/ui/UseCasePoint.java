...
public class UseCasePoint extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            //getListUseCase();
            getListUseCaseAndActorByProject(idProject);
        } catch (SQLException ex) {
            Logger.getLogger(UseCasePoint.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jComboBox8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox8ActionPerformed
        ...
        try {
            getListUseCaseAndActorByProject(projectID);
...
//            }
    ...
    private void getListUseCase() throws SQLException {
        UseCaseDAO useCaseDAO = new UseCaseDAO();
        ResultSet resultSet = useCaseDAO.getAllUseCase();
        ...
        while (resultSet.next()) {
            ...
            ((DefaultTableModel) jTable2.getModel()).insertRow(resultSet.getRow() - 1, rows);
        }
    }
    
    private void getListUseCaseAndActorByProject(String projectID) throws SQLException {
        UseCaseDAO useCaseDAO = new UseCaseDAO();
        ResultSet resultSet = useCaseDAO.getUseCaseAndActorByProject(projectID);
        while ((jTable5.getRowCount() > 0) && (jTable2.getRowCount() > 0)) {
        ...
        while (resultSet.next()) {
            ...
            ((DefaultTableModel) jTable5.getModel()).insertRow(resultSet.getRow() - 1, rows);
            ((DefaultTableModel) jTable2.getModel()).insertRow(resultSet.getRow() - 1, rows);
        }
    }
    ...
    private void getListTCF(String projectID) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            ((DefaultTableModel) jTable3.getModel()).insertRow(resultSet.getRow() - 1, rows);
        }
    }
    ...
    private void getListECF(String idProject) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            ((DefaultTableModel) jTable4.getModel()).insertRow(resultSet.getRow() - 1, rows);
        }
    }
